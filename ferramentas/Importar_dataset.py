...
class Datasets():
    ...
    def bases_linear_graduais(self, numero):
        ...
        base = (self.caminho_bases + '/Series Sinteticas/lineares_grad_abt/graduais/lin-grad' + str(numero)+ '.csv') 
        return base
    ...
    def bases_linear_abruptas(self, numero):
        ...
        base = (self.caminho_bases + '/Series Sinteticas/lineares_grad_abt/abruptas/lin-abt' + str(numero)+ '.csv') 
        return base
    ...
    def bases_nlinear_graduais(self, numero):
        ...
        base = (self.caminho_bases + '/Series Sinteticas/nlineares_grad_abt/graduais/nlin-grad' + str(numero)+ '.csv')
        return base
    ...
    def bases_nlinear_abruptas(self, numero):
        ...
        base = (self.caminho_bases + '/Series Sinteticas/nlineares_grad_abt/abruptas/nlin-abt' + str(numero)+ '.csv') 
        return base
