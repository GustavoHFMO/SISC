...
class SISC_M():
    def __init__(self, dataset, n=300, lags=5, qtd_neuronios=10, numero_particulas=10, qtd_sensores=10, qtd_memoria=30, limiar=3, w=0.25, c=0.25):
...
def main():
    ...
    w = 0.1
    c = 0.25
    alg = SISC_M(dataset, n, lags, qtd_neuronios, numero_particulas, qtd_sensores, qtd_memoria, limiar, w, c)
